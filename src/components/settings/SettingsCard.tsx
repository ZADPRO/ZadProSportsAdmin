          ...
          <div className="card flex-1">
            <Card title="Features" style={{ textAlign: "left" }}>
              ...
              <Sidebar
                ...
                style={{ width: "60%" }}
              >
              <h2 className="text-black text-xl font-bold">Ground Features</h2>
                <Features/>
          ...
          <div className="card flex-1 ">
            <Card title="User Guidelines" style={{ textAlign: "left" }}>
              ...
              <Sidebar
                ...
                style={{ width: "60%" }}
              >
                <h2  className="text-black text-xl  font-bold">User Guidelines</h2>
                <UserGuidelines/>
          ...
          <div className="card flex-1 ">
            <Card title="Facilities" style={{ textAlign: "left" }}>
              ...
              <Sidebar
                ...
                style={{ width: "60%" }}
              >
                <h2  className="text-black text-xl  font-bold">Ground Facilities</h2>
                <Facilities/>
              </Sidebar>{" "}
            </Card>
          </div>
          ...
          <div className="card flex-1">
            <Card title="Additional Tips" style={{ textAlign: "left" }}>
              ...
              <Sidebar
                ...
                style={{ width: "60%" }}
              >
                <h2  className="text-black text-xl  font-bold">Additional Tips</h2>
               <AdditionalTips/>
              </Sidebar>{" "}
            </Card>
          </div>
